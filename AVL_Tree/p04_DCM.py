...
class AVLTree:
    ...
    # Verificar si el árbol cumple la propiedad AVL
    def es_avl(self, nodo):
        if nodo is None:
            return True
        ...
        # Verificar si la diferencia de alturas de los hijos es mayor a 1
        if abs(balance) > 1:
            return False

        # Verificar recursivamente en los hijos izquierdo y derecho
        return self.es_avl(nodo.izquierda) and self.es_avl(nodo.derecha)

arbol = AVLTree()

numeros_aleatorios = random.sample(range(1, 101), 10)  # 10 números aleatorios entre 1 y 100
...
print("Verificación de la propiedad AVL en el árbol:")
if arbol.es_avl(arbol.raiz):
    print("El árbol cumple con la propiedad AVL.")
else:
    print("El árbol NO cumple con la propiedad AVL.")
